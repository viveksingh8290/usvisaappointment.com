                            ...
                            <div class="review-tab-pro-inner">
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">                                    
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        {!! Form::open(['route' => ['section1EmbassyInfoUpdate.update'], 'id' => 'section1EmbassyInfoUpdate', 'files' => true]) !!}
                                        <div class="row">                                            
                                             @if(!empty($section1))
                                                    @foreach($section1 as $product_data)
                                                    <?php
                                                        ...
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <div class="review-content-section">                                
                                                                ...
                                                                <div class="input-group mg-b-pro-edt">
                                                                    ...
                                                                    <input type="text" class="form-control" name="sub_heading" placeholder="Name" value="{{ $arr['sub_heading'] }}">
                                                                </div>
