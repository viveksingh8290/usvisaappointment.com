                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i> Visa Update</a></li>
                                    
                                </ul>
                                <div id="myTabContent" class="tab-content custom-product-edit">                                    
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        {!! Form::open(['route' => ['visa.update'], 'id' => 'visaForm', 'files' => true]) !!}
                                        <div class="row">                                            
                                             @if(!empty($section_1))
                                                    @foreach($section_1 as $product_data)
                                                    <?php
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                            <div class="review-content-section">                                
                                                                ...
                                                                <div class="input-group mg-b-pro-edt">
                                                                    <span class="input-group-addon">Page ID</span>
                                                                    <select name="page_id" class="form-control">
                                                                        ...
                                                                        <option value="c1_d">C1/D</option>
                                                                        <option value="app_step_1">Application step 1</option>
                                                                        <option value="app_step_2">Application step 1</option>
                                                                        <option value="app_step_3">Application step 1</option>
                                                                    </select>
                                                                </div>
                                                                <div class="input-group mg-b-pro-edt">
