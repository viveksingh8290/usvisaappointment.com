                            ...
                            <div class="review-tab-pro-inner">
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">                                    
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        {!! Form::open(['route' => ['bannerUpdate.update'], 'id' => 'bannerUpdateForm', 'files' => true]) !!}
                                        <div class="row">                                            
                                             @if(!empty($bannerData))
                                                    @foreach($bannerData as $product_data)
                                                    <?php
                                                        ...
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <div class="review-content-section">                                
                                                                <div class="input-group mg-b-pro-edt">
                                                                    ...
                                                                    <input type="text" class="form-control" name="main_heading" placeholder="Banner Main Heading" value="{{ $arr['main_heading'] }}">
                                                                </div>
                                                                <div class="input-group mg-b-pro-edt">
                                                                    <span class="input-group-addon">Sub Heading</span>
                                                                    <input type="text" class="form-control" name="sub_heading" placeholder="Banner Sub Heading" value="{{ $arr['sub_heading'] }}">
                                                                </div>
                                                                <div class="input-group mg-b-pro-edt">
