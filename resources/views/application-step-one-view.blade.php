                ...
                <div class="enquiry-form">                   
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" name="father_DOB_Year" id="father_DOB_Year" class="form-control" minlength="4" maxlength="4" value="{{ $f_DOB_Year }}">                               
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" name="mother_DOB_Year" id="mother_DOB_Year" class="form-control" minlength="4" maxlength="4" value="{{ $m_DOB_Year }}">                               
                            </div>
                            <div class="form-group col-md-2">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12 clr">
                ...
                <div class="enquiry-form">
                        <div class="form-row">
                            ...
                            <a href="{{ url('application-step-two-view/'.$user_id) }}" class="btn btn-default" style="float: right;"> CONTINUE TO STEP 2 </a>
                        </form>
                    </div>
                </div>
            </div>
