            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="header-block">
                        <span class="header-link d-none d-xl-block"><a href="{{ url('talk-to-our-expert') }}" class="anchor-link">Talk to Our Expert</a></span>
                        <span class="header-link"><a href="tel:+91-123456789">+91-123456789</a></span>
                       
                        <span class="header-link"><a href="{{ url('application-step-one') }}" class="btn btn-default btn-sm">Apply Now</a></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
                    <div id="navigation" class="navigation">
                      <ul>
                            ...
                            <li><a href="#">Visa</a>
                                 <ul>
                                    <li><a href="{{ url('B1') }}">B1</a></li>
                                    <li><a href="{{ url('B2') }}">B2</a></li>
                                    <li><a href="{{ url('B1-B2') }}">B1/B2</a></li>
                                    <li><a href="{{ url('J1') }}">J1</a></li>
                                    <li><a href="{{ url('F1') }}">F1</a></li>
                                    <li><a href="{{ url('C1-D') }}" onclick="c1d()">C1/D</a></li>
                                </ul>
                            </li>
                            <li><a href="{{ url('esta') }}">ESTA</a>
                            </li>
                            <li><a href="{{ url('embassy-info') }}">Embassy Info</a>
                            </li>
                            <li><a href="{{ url('about') }}">About Us</a>   
                            </li>                            
                            <li><a href="{{ url('contact-us') }}">Contact Us </a>                    
                            </li>
                         <li><a href="{{ url('application-step-one') }}">Apply For Visa</a></li>
                        </ul>
                    </div>
                </div>
            </div>
