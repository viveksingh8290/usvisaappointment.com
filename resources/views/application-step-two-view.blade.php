			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 clr">
				...
				<div class="enquiry-form">
					<div class="form-row">
						...
						<div class="form-group col-md-2">
							<label for="email">Last visit to USA date <span class="required">*</span></label>
						</div>
								<div class="form-group col-md-3">
									...
									<select name="past_visit_date" style="width: 100%; height: 32px;">
										<?php
											for ($i=1; $i < 32; $i++) { 
												?>
													<option value="{{ $i }}" <?php if($past_visit_date == $i){ echo 'selected'; } ?>><?php echo $i; ?></option>
												<?php
											}
										?>
									</select>
						...
						<div class="form-group col-md-2">
							<label for="email">How long was your trip?<span class="required">*</span></label>
								...
								<div class="form-group col-md-3">
									<label for="past_visit_duration">Day<span class="required"></span></label>
									<input type="text" class="form-control" id="past_visit_duration" name="past_visit_duration" value="<?php echo $past_visit_duration; ?>">
								</div>
								<div class="form-group col-md-3">
									<label for="past_visit_duration_month">Month<span class="required">*</span></label>
									<input type="text" name="past_visit_duration_month" id="past_visit_duration_month" class="form-control" minlength="4" maxlength="4" value="<?php echo $past_visit_duration_month; ?>">
								</div>
						...
						<div class="form-group col-md-3"></div>
						<div class="form-group col-md-2">
							<label for="past_visa_refuse_reason"> Explain<span class="required">*</span></label>
						</div>
								<div class="form-group col-md-9">
						...
						<div class="form-group col-md-3"></div>
						<div class="form-group col-md-2">
							<label for="past_visa_immigration_reason"> Explain<span class="required">*</span></label>
						</div>
								<div class="form-group col-md-9">
						...
						<div class="form-group col-md-3"></div>
						<div class="form-group col-md-2">
							<label for="past_visa_esta_reason"> Explain<span class="required">*</span></label>
						</div>
								<div class="form-group col-md-9">
						...
						<div class="form-group col-md-3"></div>
						<div class="form-group col-md-2">
							<label for="past_visa_entry_refuse_reason"> Explain<span class="required">*</span></label>
						</div>
								<div class="form-group col-md-9">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 clr">
				...
				<div class="enquiry-form">
						...
						<div class="form-row">
							...
							<a href="{{ url('application-step-three-view/'.$user_id) }}" class="btn btn-default" style="float: right;"> CONTINUE TO STEP 3 </a>
