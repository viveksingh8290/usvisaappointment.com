            ...
            <div class="row" style="padding-top: 10px; background: #D11F04; margin-right: 0px;">
                ...
                <div class="col-xs-6 col-md-6 col-lg-6 col-sm-6 vcenter pull-right">
                    <ul class="breadcome-menu vcenter" style="padding-right: 20px; padding-bottom: 10px;">
                        ...
                        <li><span class="bread-blod">Embassy Info banner</span> </li>
                    </ul>
                </div>
            </div> 
        <!-- breadcome --> 
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i> Embassy Info banner</a></li>
                                    
                                </ul>
                                <div id="myTabContent" class="tab-content custom-product-edit">                                    
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <?php echo Form::open(['route' => ['section1EmbassyInfoUpdate.update'], 'id' => 'section1EmbassyInfoUpdate', 'files' => true]); ?>

                                        <div class="row">                                            
                                             <?php if(!empty($section1)): ?>
                                                    <?php $__currentLoopData = $section1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                        ...
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <div class="review-content-section">                                
                                                                ...
                                                                <div class="input-group mg-b-pro-edt">
                                                                    ...
                                                                    <input type="text" class="form-control" name="sub_heading" placeholder="Name" value="<?php echo e($arr['sub_heading']); ?>">
                                                                </div>
...
<?php echo $__env->make('dashboard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tour\resources\views/dashboard/banner-section-embassy-info.blade.php ENDPATH**/ ?>