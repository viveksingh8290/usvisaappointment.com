...
<?php
	...
	?>
<?php echo Form::open(['route' => ['additionalInformation.update'], 'id' => 'additionalInformationUpdate', 'method' => 'post', 'files' => true]); ?>
...
<?php if(!empty($AddInfo)): ?>
	<?php $__currentLoopData = $AddInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $add_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<?php
								...
								<div class="form-group col-md-3 past_visit">
									...
									<select name="past_visit_date" style="width: 100%; height: 32px;" required class="past_visit">
										<?php
											for ($i=1; $i < 32; $i++) { 
												?>
													<option value="<?php echo e($i); ?>" <?php if($i == $past_visit_date){ echo "selected"; } ?>><?php echo $i; ?></option>
												<?php
											}
										?>
									</select>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('_layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\usa_visa_latest\resources\views/application-step-two.blade.php ENDPATH**/ ?>