            ...
            <div class="row" style="padding-top: 10px; background: #D11F04; margin-right: 0px;">
                ...
                <div class="col-xs-6 col-md-6 col-lg-6 col-sm-6 vcenter pull-right">
                    <ul class="breadcome-menu vcenter" style="padding-right: 20px; padding-bottom: 10px;">
                        ...
                        <li><span class="bread-blod">About us section 2</span> </li>
                    </ul>
                </div>
            </div> 
        <!-- breadcome --> 
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i> About us section 2</a></li>
                                    
                                </ul>
                                <div id="myTabContent" class="tab-content custom-product-edit">                                    
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <?php echo Form::open(['route' => ['section2AboutUpdate.update'], 'id' => 'section2AboutUpdate', 'files' => true]); ?>
                                                        ...
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <div class="review-content-section">                                
                                                                <div class="input-group mg-b-pro-edt">
                                                                    ...
                                                                    <input type="text" class="form-control" name="main_heading" placeholder="message" value="<?php echo e($arr['main_heading']); ?>">
                                                                </div>
                                                                <div class="input-group mg-b-pro-edt">
                                                                    <span class="input-group-addon">Sub Heading</span>
                                                                    
                                                                    <textarea class="form-control" name="sub_heading" rows="3" cols="3" placeholder="sub_heading"><?php echo e($arr['sub_heading']); ?>
                                                                ...
                                                                <div class="input-group mg-b-pro-edt">
                                                                    ...
                                                                    <textarea class="form-control" name="detail_text" rows="3" cols="3" placeholder="detail_text"><?php echo e($arr['detail_text']); ?>
                                                                ...
                                                                <div class="input-group mg-b-pro-edt">
                                                                    ...
                                                                    <textarea class="form-control" name="extra_text" rows="3" cols="3" placeholder="extra_text"> <?php echo e($arr['extra_text']); ?>
...
<?php echo $__env->make('dashboard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tour\resources\views/dashboard/section-2-about.blade.php ENDPATH**/ ?>