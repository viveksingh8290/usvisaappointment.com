                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i> Banner Update</a></li>
                                    
                                </ul>
                                <div id="myTabContent" class="tab-content custom-product-edit">                                    
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <?php echo Form::open(['route' => ['bannerUpdate.update'], 'id' => 'bannerUpdateForm', 'files' => true]); ?>

                                        <div class="row">                                            
                                             <?php if(!empty($bannerData)): ?>
                                                    <?php $__currentLoopData = $bannerData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                        ...
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <div class="review-content-section">                                
                                                                <div class="input-group mg-b-pro-edt">
                                                                    ...
                                                                    <input type="text" class="form-control" name="main_heading" placeholder="Banner Main Heading" value="<?php echo e($arr['main_heading']); ?>">
                                                                </div>
                                                                <div class="input-group mg-b-pro-edt">
                                                                    <span class="input-group-addon">Sub Heading</span>
                                                                    <input type="text" class="form-control" name="sub_heading" placeholder="Banner Sub Heading" value="<?php echo e($arr['sub_heading']); ?>">
                                                                </div>
                                                                <div class="input-group mg-b-pro-edt">
                                                                    <span class="input-group-addon">Button Name</span>
                                                                    <input type="text" class="form-control" name="button_name" placeholder="button_name" value="<?php echo e($arr['button_name']); ?>">
                                                                </div>
                                                                <div class="input-group mg-b-pro-edt">
                                                                    <span class="input-group-addon">Button Action</span>
                                                                    <input type="text" class="form-control" name="button_action" placeholder="button_action" value="<?php echo e($arr['button_action']); ?>">
                                                                </div>
                                                                <div class="input-group mg-b-pro-edt">
...
<?php echo $__env->make('dashboard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tour\resources\views/dashboard/edit-banner-home.blade.php ENDPATH**/ ?>