                            ...
                            <div class="review-tab-pro-inner">
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">                                    
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <?php echo Form::open(['route' => ['section2ContactUpdate.update'], 'id' => 'section2ContactUpdate', 'files' => true]); ?>

                                        <div class="row">                                            
                                             <?php if(!empty($section2)): ?>
                                                    <?php $__currentLoopData = $section2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                   <?php                                                   
                                                        ...
                                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                            <div class="review-content-section">                                
                                                                <div class="input-group mg-b-pro-edt">
                                                                    ...
                                                                    <input type="text" class="form-control" name="main_heading_left" placeholder="main_heading_left" value="<?php echo e($arr['main_heading_left']); ?>">
                                                                </div>
                                                                <div class="input-group mg-b-pro-edt">
                                                                    <span class="input-group-addon">Sub Heading Left</span>
                                                                    <input type="text" class="form-control" name="sub_heading_left" placeholder="sub_heading_left" value="<?php echo e($arr['sub_heading_left']); ?>">
                                                                </div>
                                                                <div class="input-group mg-b-pro-edt">
                                                                    <span class="input-group-addon">Main Heading Right</span>
                                                                    <input type="text" class="form-control" name="main_heading_right" placeholder="main_heading_right" value="<?php echo e($arr['main_heading_right']); ?>">
                                                                </div>
                                                                <div class="input-group mg-b-pro-edt">
                                                                    <span class="input-group-addon">Sub Heading Right</span>
                                                                    <input type="text" class="form-control" name="sub_heading_right" placeholder="sub_heading_right" value="<?php echo e($arr['sub_heading_right']); ?>">
                                                                </div>

                                                                <div class="input-group mg-b-pro-edt">
                                                                    <span class="input-group-addon">Phone </span>
                                                                    <input type="text" class="form-control" name="phone" placeholder="phone" value="<?php echo e($arr['phone']); ?>">
                                                                </div>
                                                                <div class="input-group mg-b-pro-edt">
                                                                    <span class="input-group-addon">Email</span>
                                                                    <input type="text" class="form-control" name="email" placeholder="email" value="<?php echo e($arr['email']); ?>">
                                                                </div>
                                                                <div class="input-group mg-b-pro-edt">
                                                                    <span class="input-group-addon">Inquiry </span>
                                                                    <input type="text" class="form-control" name="inquiry" placeholder="inquiry" value="<?php echo e($arr['inquiry']); ?>">
                                                                </div>
                                                                <div class="input-group mg-b-pro-edt">
                                                                    <span class="input-group-addon">Work </span>
                                                                    <input type="text" class="form-control" name="work" placeholder="work" value="<?php echo e($arr['work']); ?>">
                                                                </div>
                                                                <div class="input-group mg-b-pro-edt">
                                                                    <span class="input-group-addon">Feedback </span>
                                                                    <input type="text" class="form-control" name="feedback" placeholder="feedback" value="<?php echo e($arr['feedback']); ?>">
                                                                </div>
                                                                <div class="input-group mg-b-pro-edt">
                                                                    <span class="input-group-addon">alliance </span>
                                                                    <input type="text" class="form-control" name="alliance" placeholder="alliance" value="<?php echo e($arr['alliance']); ?>">
                                                                </div>
...
<?php echo $__env->make('dashboard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tour\resources\views/dashboard/section2-contact-edit.blade.php ENDPATH**/ ?>