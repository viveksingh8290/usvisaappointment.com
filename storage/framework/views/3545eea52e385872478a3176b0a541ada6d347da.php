...
<?php
	...
	?>
<?php echo Form::open(['route' => ['additionalQuestion.update'], 'id' => 'additionalQuestion', 'method' => 'post', 'files' => true]); ?>
					...
					<form method="post" action="#">
						<div class="form-row">
							...
							<div class="form-group col-md-9 addn_student">
								<input type="text" class="form-control addn_student" id="addn_school" name="addn_school" required="">
							</div>
							<div class="form-group col-md-2 addn_student">
								<label for="addn_street_address" class=" addn_student">Street Address<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_student">
								<input type="text" class="form-control addn_student" id="addn_street_address" name="addn_street_address" required="">
							</div>
							<div class="form-group col-md-2 addn_student">
								<label for="addn_city" class=" addn_student">City<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_student">
								<input type="text" class="form-control addn_student" id="addn_city" name="addn_city" required="">
							</div>
							<div class="form-group col-md-2 addn_student">
								<label for="addn_state" class=" addn_student">State/Province<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_student">
								<input type="text" class="form-control addn_student" id="addn_state" name="addn_state" required="">
							</div>
							<div class="form-group col-md-2 addn_student">
								<label for="addn_country" class=" addn_student">Country<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_student">
								<input type="text" class="form-control addn_student" id="addn_country" name="addn_country" required="">
							</div>
							<div class="form-group col-md-2 addn_student">
								<label for="addn_major" class=" addn_student">Major<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_student">
								<input type="text" class="form-control addn_student" id="addn_major" name="addn_major" required="">
							</div>
							<div class="form-group col-md-2 addn_student">
								<label for="addn_duties" class=" addn_student">Please describe your duties<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_student">
								<input type="text" class="form-control addn_student" id="addn_duties" name="addn_duties" required="">
							</div>
							<hr/>
							<div class="form-group col-md-2">
							...
							<div class="form-group col-md-9 addn_working">
								<select name="addn_working_desc" style="width: 100%; height: 32px;" class=" addn_working">
									...
									<option value="A"  selected>Agriculture</option>
									...
									<option value="C" >Food Services</option>
							...
							<div class="form-group col-md-9 addn_working">
								<input type="text" class="form-control addn_working" id="addn_occupation" name="addn_occupation" required="">
							</div>
							<div class="form-group col-md-2 addn_working">
								<label for="addn_employer" class=" addn_working">Name of employer<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_working">
								<input type="text" class="form-control addn_working" id="addn_employer" name="addn_employer" required="">
							</div>
							<div class="form-group col-md-2 addn_working">
								<label for="addn_employer_address" class=" addn_working">Street Address<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_working">
								<input type="text" class="form-control addn_working" id="addn_employer_address" name="addn_employer_address" required="">
							</div>
							<div class="form-group col-md-2 addn_working">
								<label for="addn_employer_unit_number" class=" addn_working">Employer's Suite/Unit Number<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_working">
								<input type="text" class="form-control addn_working" id="addn_employer_unit_number" name="addn_employer_unit_number" required="">
							</div>
							<div class="form-group col-md-2 addn_working">
								<label for="addn_emp_city" class=" addn_working">City<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_working">
								<input type="text" class="form-control addn_working" id="addn_emp_city" name="addn_emp_city" required="">
							</div>
							<div class="form-group col-md-2 addn_working">
								<label for="addn_emp_state" class=" addn_working">State/Province<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_working">
								<input type="text" class="form-control addn_working" id="addn_emp_state" name="addn_emp_state" required="">
							</div>
							<div class="form-group col-md-2 addn_working">
								<label for="addn_emp_zip" class=" addn_working">ZIP or Postal Code<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_working">
								<input type="text" class="form-control addn_working" id="addn_emp_zip" name="addn_emp_zip" required="">
							</div>
							<div class="form-group col-md-2 addn_working">
								<label for="addn_emp_country" class=" addn_working">Country<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_working">
								<input type="text" class="form-control addn_working" id="addn_emp_country" name="addn_emp_country" required="">
							</div>
							<div class="form-group col-md-2 addn_working">
								<label for="addn_duties_desc" class=" addn_working">Please describe your duties<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_working">
								<input type="text" class="form-control addn_working" id="addn_duties_desc" name="addn_duties_desc" required="">
							</div>
							<div class="form-group col-md-2 addn_working">
							...
							<div class="form-group col-md-9 addn_working">
								<input type="text" class="form-control addn_working" id="addn_income" name="addn_income" required="">
							</div>
							<hr/>
							<div class="form-group col-md-2">
							...
							<div class="form-group col-md-9 addn_prev_emp">
								<input type="text" class="form-control addn_prev_emp" id="addn_prev_emp_name" name="addn_prev_emp_name" required="">
							</div>
							<div class="form-group col-md-2 addn_prev_emp">
								<label for="addn_prev_emp_title" class=" addn_prev_emp">What was your job title in this job?<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_prev_emp">
								<input type="text" class="form-control addn_prev_emp" id="addn_prev_emp_title" name="addn_prev_emp_title" required="">
							</div>
							<div class="form-group col-md-2 addn_prev_emp">
							...
							<div class="form-group col-md-9 addn_prev_emp">
								<input type="text" class="form-control addn_prev_emp" id="addn_prev_emp_duties" name="addn_prev_emp_duties" required="">
							</div>
							<div class="form-group col-md-2 addn_prev_emp">
								<label for="addn_prev_emp_supervisor" class=" addn_prev_emp">Supervisor's Surname<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_prev_emp">
								<input type="text" class="form-control addn_prev_emp" id="addn_prev_emp_supervisor" name="addn_prev_emp_supervisor" required="">
							</div>
							<div class="form-group col-md-2 addn_prev_emp">
								<label for="addn_prev_emp_city" class=" addn_prev_emp">City<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_prev_emp">
								<input type="text" class="form-control addn_prev_emp" id="addn_prev_emp_city" name="addn_prev_emp_city" required="">
							</div>
							<div class="form-group col-md-2 addn_prev_emp">
								<label for="addn_prev_emp_super_name" class=" addn_prev_emp">Supervisor's Given Name<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_prev_emp">
								<input type="text" class="form-control addn_prev_emp" id="addn_prev_emp_super_name" name="addn_prev_emp_super_name" required="">
							</div>
							<div class="form-group col-md-2 addn_prev_emp">
								<label for="addn_prev_emp_address" class=" addn_prev_emp">Street Address<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_prev_emp">
								<input type="text" class="form-control addn_prev_emp" id="addn_prev_emp_address" name="addn_prev_emp_address" required="">
							</div>
							<div class="form-group col-md-2 addn_prev_emp">
								<label for="addn_apartment" class=" addn_prev_emp">Apartment/Suite/Unit Number<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_prev_emp">
								<input type="text" class="form-control addn_prev_emp" id="addn_apartment" name="addn_apartment" required="">
							</div>
							<div class="form-group col-md-2 addn_prev_emp">
								<label for="addn_apartment_city" class=" addn_prev_emp">City<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_prev_emp">
								<input type="text" class="form-control addn_prev_emp" id="addn_apartment_city" name="addn_apartment_city" required="">
							</div>
							<div class="form-group col-md-2 addn_prev_emp">
								<label for="addn_apartment_state" class=" addn_prev_emp">State/Province<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_prev_emp">
								<input type="text" class="form-control addn_prev_emp" id="addn_apartment_state" name="addn_apartment_state" required="">
							</div>
							<hr/>
							<div class="form-group col-md-2">
							...
							<div class="form-group col-md-9 addn_academic">
								<input type="text" class="form-control addn_academic" id="addn_academic_name" name="addn_academic_name" required="">
							</div>
							<div class="form-group col-md-2 addn_academic">
								<label for="addn_academic_address" class=" addn_academic">Street Address<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_academic">
								<input type="text" class="form-control addn_academic" id="addn_academic_address" name="addn_academic_address" required="">
							</div>
							<div class="form-group col-md-2 addn_academic">
								<label for="addn_academic_city" class=" addn_academic">City<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9">
								<input type="text" class="form-control addn_academic" id="addn_academic_city" name="addn_academic_city" required="">
							</div>
							<div class="form-group col-md-2 addn_academic">
								<label for="addn_academic_state" class=" addn_academic">State/Province<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_academic">
								<input type="text" class="form-control addn_academic" id="addn_academic_state" name="addn_academic_state" required="">
							</div>
							<div class="form-group col-md-2 addn_academic">
								<label for="addn_academic_country" class=" addn_academic">Country<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_academic">
								<input type="text" class="form-control addn_academic" id="addn_academic_country" name="addn_academic_country" required="">
							</div>
							<div class="form-group col-md-2 addn_academic">
								<label for="addn_academic_major" class=" addn_academic">Major<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_academic">
								<input type="text" class="form-control addn_academic" id="addn_academic_major" name="addn_academic_major" required="">
							</div>
							<div class="form-group col-md-2 addn_academic">
								<label for="addn_academic_duties" class=" addn_academic">Please describe your duties<span class="required">*</span></label>
							</div>
							<div class="form-group col-md-9 addn_academic">
								<input type="text" class="form-control addn_academic" id="addn_academic_duties" name="addn_academic_duties" required="">
							</div>
							<hr/>
						</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('_layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\usa_visa_latest\resources\views/application-step-three.blade.php ENDPATH**/ ?>