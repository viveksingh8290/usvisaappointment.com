    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('css/owl.theme.default.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('css/fontello.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('css/style.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('css/min.css')); ?>"><?php /**PATH C:\Users\Vivek\Downloads\Microsoft.SkypeApp_kzf8qxf38zg5c!App\All\tour\resources\views/_layouts/style.blade.php ENDPATH**/ ?>